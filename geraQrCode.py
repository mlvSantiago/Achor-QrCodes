...
for i in range(planilha.shape[0]):
    ...
    # 🟦 1. LOGO
    # -------------------------------------------------------------------
    logo = Image.open("./logo/Achor_logo.png")
    ...
    texto = display.upper()  # usar o display como texto
    ...
    fonte = ImageFont.truetype("./fonte/moon_get-Heavy.ttf", 36)
    ...
    # 🟦 3. SALVAR
    # -------------------------------------------------------------------
    img_final.save(f"./qrCodes/{display}.png")
